                    ...
                    <div class="card-body">
                        ...
                        <div class ="row row-space">
                            ...
                            <div class="col-4" style="margin-right: -11px;">
                                ...
                                <input type="text" id="last_name" name="last_name" class="form-control" style="width: 214px; height: 38px; background: #F4F4F4;">
                                    @error('last_name')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                            </div>
                            ...
                            <div class="col-4" style="margin-right: -11px;">
                                ...
                                <input type="text" id="middle_name" name="middle_name" class="form-control" style="width: 214px; height: 38px; background: #F4F4F4;">
                                    @error('middle_name')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                            </div>
                        ...
                        <div class ="row row-space">
                            <div class="col-4">
                                ...
                                <input type="text" id="address" name="address" class="form-control" style="width: 680px; height: 38px; background: #F4F4F4;">
                                    @error('address')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                            </div>
                        ...
                        <div class ="row row-space">
                            <div class="col-4" style="margin-right: -11px;">
                                ...
                                <input type="text" id="contact_number" name="contact_number" class="form-control" style="width: 214px; height: 38px; background: #F4F4F4;">
                            ...
                            <div class="col-4" style="margin-right: -11px;">
                                ...
                                <input type="text" id="sss_number" name="sss_number" class="form-control" style="width: 214px; height: 38px; background: #F4F4F4;">
                                @error('sss_number')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-4">
                                ...
                                <input type="text" id="tin_number" name="tin_number" class="form-control" style="width: 214px; height: 38px; background: #F4F4F4;">
                                @error('tin_number')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class ="row row-space">
                            <div class="col-4" style="margin-right: -11px;">
                                ...
                                <input type="text" id="date_of_birth" name="date_of_birth" class="form-control" style="width: 214px; height: 38px; background: #F4F4F4;">
                                @error('date_of_birth')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-4" style="margin-right: -11px;">
                                ...
                                <input type="text" id="place_of_birth" name="place_of_birth" class="form-control" style="width: 214px; height: 38px; background: #F4F4F4;">
                        ...
                        <div class ="row row-space">
                            <div class="col-4">
                                ...
                                <input type="text" id="email_address" name="email_address" class="form-control" style="width: 680px; height: 38px; background: #F4F4F4;">
                                @error('email_address')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-4" style="margin-right: -11px;">
                            ...
                            <input type="text" id="sex" name="sex" class="form-control" style="width: 214px; height: 38px; background: #F4F4F4;">
                            @error('sex')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-4" style="margin-right: -11px;">
                            ...
                            <input type="text" id="civil_status" name="civil_status" class="form-control" style="width: 214px; height: 38px; background: #F4F4F4;">
                            @error('civil_status')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class ="row row-space">
                            <div class="col-4" style="margin-right: -11px;">
                                ...
                                <input type="text" id="spouse_first_name" name="spouse_first_name" class="form-control" style="width: 214px; height: 38px; background: #F4F4F4;">
                            ...
                            <div class="col-4" style="margin-right: -11px;">
                                ...
                                <input type="text" id="last_name_spouse" name="last_name_spouse" class="form-control" style="width: 214px; height: 38px; background: #F4F4F4;">
                            ...
                            <div class="col-4">
                                ...
                                <input type="text" id="middle_name_spouse" name="middle_name_spouse" class="form-control" style="width: 214px; height: 38px; background: #F4F4F4;">
                        ...
                        <div class="col-4">
                            ...
                            <input type="text" id="existing_insurance_provider" name="existing_insurance_provider" class="form-control" style="width: 680px; height: 38px; background: #F4F4F4;">
                        ...
                        <div class="col-4" style="margin-right: -11px;">
                            ...
                            <input type="text" id="bank_name" name="bank_name" class="form-control" style="width: 214px; height: 38px; background: #F4F4F4;">
                            @error('bank_name')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-4" style="margin-right: -11px;">
                            ...
                            <input type="text" id="account_number" name="account_number" class="form-control" style="width: 214px; height: 38px; background: #F4F4F4;">
                        ...
                        <div class ="row row-space">
                            <div class="col-4" style="margin-right: -11px;">
                                ...
                                <input type="text" id="company_name" name="company_name" class="form-control" style="width: 214px; height: 38px; background: #F4F4F4;">
                                @error('company_name')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-4" style="margin-right: -11px;">
                                ...
                                <input type="text" id="job_title" name="job_title" class="form-control" style="width: 214px; height: 38px; background: #F4F4F4;">
                                @error('job_title')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class ="row row-space">
                            <div class="col-4">
                                ...
                                <input type="text" id="business_address" name="business_address" class="form-control" style="width: 680px; height: 38px; background: #F4F4F4;">
                        ...
                        <div class ="row row-space">
                            <div class="col-4" style="margin-right: -11px;">
                                ...
                                <input type="text" id="telephone" name="telephone" class="form-control" style="width: 214px; height: 38px; background: #F4F4F4;">
                                @error('telephone')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-4" style="margin-right: -11px;">
                                ...
                                <input type="text" id="phone_number_company" name="phone_number_company" class="form-control" style="width: 214px; height: 38px; background: #F4F4F4;">
                            ...
                            <div class="col-4">
                                ...
                                <input type="text" id="fax" name="fax" class="form-control" style="width: 214px; height: 38px; background: #F4F4F4;">
                                @error('fax')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row row-space">
                            ...
                            <div class="col-5" style="display: flex; align-items: center;">
                                ...
                                <span style="width: 210px height: 12px; flex-shrink: 0; color: #626262; font-family: Montserrat; font-size: 10px; font-style: normal; font-weight: 400; line-height: normal; margin-left:5px;">
                                    Proof of Bank Account (Online / Bank Book)
                                </span>
                                <div class="col-6" style="display: flex; align-items: center;">
                                    <label for="bankFileInput" class="custom-button" style="display: flex; align-items: center; cursor: pointer; margin-left:-10px;">
                                        <img src="{{ asset('assets/Upload.png') }}" alt="Icon" class="icon" style="margin-left:7px; margin-right:2px;">
                          ...
                          <div class="row row-space" style="margin-top:15px;">
                            ...
                            <div class="col-5" style="display: flex; align-items: center;">
                                ...
                                <div class="col-6" style="display: flex; align-items: center;">
                                    <label for="commissionFileInput" class="custom-button" style="display: flex; align-items: center; cursor: pointer; margin-left:-2px;">
                                        <img src="{{ asset('assets/Upload.png') }}" alt="Icon" class="icon"  style="margin-left:7px; margin-right:2px;">
                                        <span class="button-text" style="color: #FFF; font-family: Montserrat; font-size: 8px; font-style: normal; font-weight: 400; line-height: normal;">
                                            Choose a file...
                                        </span>
